...
// MUDO investigate: expectType<CallableFunction['apply']>(anyFunction1b.apply)
// MUDO investigate: expectType<CallableFunction['call']>(anyFunction1b.call)
// MUDO investigate: expectType<CallableFunction['bind']>(anyFunction1.bind)
// `prototype` is defined with type `any` in `lib.es5.d.ts`, and there is nothing we can do about that … (***)
...
expectType<Function['toString']>(anyCallableFunction.toString)
// MUDO investigate: expectType<NewableFunction['apply']>(anyCallableFunction.apply)
// MUDO investigate: expectType<NewableFunction['call']>(anyCallableFunction.call)
// MUDO investigate: expectType<NewableFunction['bind']>(anyCallableFunction.bind)
...
// MUDO investigate: expectType<CallableFunction['apply']>(anyFunction2b.apply)
// MUDO investigate: expectType<CallableFunction['call']>(anyFunction2b.call)
// MUDO investigate: expectType<CallableFunction['bind']>(anyFunction2b.bind)
// `prototype` is defined with type `any` in `lib.es5.d.ts`, and there is nothing we can do about that … (***)
