...
expectType<NewableFunction['bind']>(ANewableGeneralContractFunction.bind)
...
expectAssignable<new (b: number) => ANewableFunction>(boundA2)
// MUDO expectAssignable<GeneralContractFunction<AbstractContract<new (b: number) => ANewableGeneralContractFunction, SomeError>>>(boundA2)
...
expectAssignable<new () => ANewableFunction>(boundA3)
// MUDO expectAssignable<GeneralContractFunction<AbstractContract<new () => ANewableGeneralContractFunction, SomeError>>>(boundA3)
...
// MUDO expectType<typeof ANewableFunction.bind & NewableBind<AbstractContract<typeof ANewableFunction, SomeError>>>(aNewableGeneralContractFunctionB.bind)
...
// MUDO expectType<typeof ANewableFunction.bind & NewableBind<AbstractContract<typeof ANewableFunction, SomeError>>>(aNewableGeneralContractFunctionC.bind)
