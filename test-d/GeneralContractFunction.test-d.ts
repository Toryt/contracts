...
expectType<AFunction1['bind'] & CallableBind<AbstractContract<AFunction1, SomeError>>>(aCallableGeneralContractFunctionB.bind)
...
expectType<AFunction1['bind'] & CallableBind<AbstractContract<AFunction1, SomeError>>>(aCallableGeneralContractFunctionC.bind)
// TODO this is still using the overloaded CallableFunction methods
