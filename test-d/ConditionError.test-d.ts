...
import { BaseContract } from '../lib/AbstractContract'
...
expectType<GeneralContractFunction<BaseContract>>(aConditionError.contractFunction)
...
expectType<unknown>(aConditionError.args[0])
