...
const conditionMetaErrorCommon = require('../02.IV/ConditionMetaErrorCommon')
const preconditionViolationCommon = require('../02.IV/PreconditionViolationCommon')
const postconditionViolationCommon = require('../02.IV/PostconditionViolationCommon')
const exceptionConditionViolationCommon = require('../02.IV/ExceptionConditionViolationCommon')
...
describe('v/ContractFunction-ArrowFunctions', function () {
