...
(function(factory) {
  ...
  var dependencies = ["../_util/describe", "../_util/it", "../_util/expect", "../_util/testUtil",
                      "𝕋合同/_private/util", "𝕋合同/III/AbstractContract", "𝕋合同/III/ConditionMetaError",
                      "𝕋合同/III/PreconditionViolation", "𝕋合同/III/PostconditionViolation",
                      "𝕋合同/III/ExceptionConditionViolation",
  ...
  if (typeof define === "function" && define.amd) {
    ...
    module.exports =
      factory.apply(undefined, dependencies.map(function(d) {return require(d.replace("𝕋合同", "../../src"));}));
           ...
           AbstractContract, ConditionMetaError,
  ...
  function generateDescriptions(name, ImplementationContract) {
    /* This test is not included in XImplementationContract.generatePrototypeMethodsDescriptions, because it is
       ...
       XImplementationContract.generatePrototypeMethodsDescriptions tests the state postconditions only. */
    ...
    //noinspection FunctionTooLongJS,JSHint
      describe("III/" + name, function() {
        ...
        fibonacci = new ImplementationContract({
          pre: [
        ...
        var factorialContract = new ImplementationContract({
          pre: [
            function(n) {return util.isInteger(n);},
            function(n) {return 0 <= n;}
          ],
        ...
        var defensiveIntegerSum = new ImplementationContract({
          post: [
            function(n, result) {return util.isInteger(result);},
        ...
        var contractWithAFailingPre = new ImplementationContract(
          {
        ...
        it("fails with a meta-error when a postcondition is kaput", function() {
          var contractWithAFailingPost = new ImplementationContract({
        ...
        it("fails with a meta-error when an exception condition is kaput", function() {
          ...
          var contractWithAFailingExceptionCondition = new ImplementationContract({
        ...
        //noinspection LocalVariableNamingConventionJS
        var PersonConstructorContract = new ImplementationContract({
          pre: [
