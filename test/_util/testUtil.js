...
import * as util from '../../src/_private/util'
import {expect} from 'chai'

// noinspection FunctionNamingConventionJS
export function x () { // MUDO use cartesian
...
export function expectOwnFrozenProperty (subject, propertyName) {
...
// noinspection FunctionNamingConventionJS
export function expectDerivedPropertyOnAPrototype (subject, propertyName, configurable) {
...
// noinspection FunctionNamingConventionJS
export function expectConfigurableDerivedPropertyOnAPrototype (subject, propertyName) {
  expectDerivedPropertyOnAPrototype(subject, propertyName, true)
}

// noinspection FunctionNamingConventionJS
export function expectFrozenDerivedPropertyOnAPrototype (subject, propertyName) {
  expectDerivedPropertyOnAPrototype(subject, propertyName, false)
}

export function expectFrozenPropertyOnAPrototype (subject, propertyName) {
  const prototype = prototypeThatHasOwnPropertyDescriptor(subject, propertyName)
  expectOwnFrozenProperty(prototype, propertyName)
}

// noinspection FunctionNamingConventionJS
export function expectFrozenReadOnlyArrayPropertyWithPrivateBackingField (subject, propName, privatePropName) {
...
export function expectToBeArrayOfFunctions (a) {
...
export function propertyIsWritable (object, propertyName) {
...
export function anyCasesGenerators (discriminator) {
