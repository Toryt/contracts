...
import * as testUtil from '../_util/testUtil'
import * as stacks from './stacks'
import {expect} from 'chai'

// MUDO amdModule no longer supported
const fileName = (testUtil.environment === 'node') ? (typeof module !== 'undefined' && module.filename) || amdModule.uri // in node, commonjs or AMD
...
describe('_private/util', function () {
  ...
  describe('#conciseConditionRepresentation', function () {
    ...
    const stuff2 = stuff
      ...
      .map(function (s) { return s.subject })
    stuff2.push(generateMultiLineAnonymousFunction())
