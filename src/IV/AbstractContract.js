...
function AbstractContract (kwargs, /* Object? */ internalLocation) {
  ...
  util.pre(() => !internalLocation || internalLocation === AbstractContract.internalLocation)
...
AbstractContract.bless = function bless (contractFunction, contract, implFunction, location) {
  ...
  util.pre(() => location === AbstractContract.internalLocation || util.isALocationOutsideLibrary(location))
