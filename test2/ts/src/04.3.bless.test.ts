...
describe(testName(import.meta), function () {
  it('behaves as expected', function () {
    ...
    expectOwnFrozenProperty(blessed, 'contract')
    Object.getPrototypeOf(blessed.contract).should.equal(contract)
    expectOwnFrozenProperty(blessed, 'implementation')
    blessed.implementation.should.equal(implFunction)
    expectOwnFrozenProperty(blessed, 'location')
    blessed.location.should.equal(here)
    expectOwnFrozenProperty(blessed, 'bind')
    blessed.bind.should.equal(contractFunctionBind)
