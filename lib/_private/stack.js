 ...
 * The default is '\n' (Unix).
 */
const stackEOL = new Error(message).stack.startsWith(message + rn) ? rn : '\n'
...
const stack = {
  /**
   * The EOL used by this JavaScript engine in Error stack traces.
   * This turns out not to be the os.EOL in all engines.
   */
  EOL: stackEOL,
