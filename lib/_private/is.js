...
const anArgumentsToString = (function () { return '' + arguments })()
...
const is = {
  ...
  isAStack: function (stack) {
    ...
    return lines && lines.length > 0 && lines.every(l => is.isAStackLocation(l))
  },

  isFrozenOwnProperty: function (obj, propName) {
    // MUDO util.pre(() => obj !== null && obj !== undefined)
