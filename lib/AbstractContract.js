...
AbstractContract.bindContractFunction = function bind () {
  ...
  /* TODO: This is wrong: the contract of the bound function is different: it has less arguments, and thus its
           conditions have less arguments too. This means some conditions should no longer be checked.
           But the conditions of the arguments that are bound should be checked here! */
