...
function ConditionViolation (contractFunction, condition, self, args) {
  ...
  ConditionError.call(this, contractFunction, condition, self, args, stack.raw(7))
}
...
property.setAndFreeze(
  ...
  function (contractFunction, condition, self, args) {
    ...
    try {
      ...
      const cme = new ConditionMetaError(contractFunction, condition, self, args, err, stack.raw(5))
      Object.freeze(cme)
      throw cme
    }
    if (!conditionResult) {
