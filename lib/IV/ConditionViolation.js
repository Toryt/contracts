 ...
 */
property.setAndFreeze(ConditionViolation.prototype, 'verifyAllPromise', function (
  contractFunction,
  conditions,
  self,
  args
 ...
 */
property.setAndFreeze(ConditionViolation.prototype, 'verifyPromise', function (contractFunction, condition, self, args) {
  assert(
    AbstractContract.isAGeneralContractFunction(contractFunction),
