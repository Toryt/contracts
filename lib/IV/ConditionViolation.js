...
function ConditionViolation (contractFunction, condition, self, args) {
  ...
  ConditionError.call(this, contractFunction, condition, self, args, util.callerStack(7))
}
  ...
  function (contractFunction, conditions, self, args) {
    ...
    util.pre(this, function () {
      return conditions &&
               ...
               conditions.every(function (c) { return typeof c === 'function' })
    })
    util.pre(this, function () { return args && (util.isArguments(args) || Array.isArray(args)) })
...
util.setAndFreezeProperty(
  ...
  function (contractFunction, condition, self, args) {
    ...
    try {
      ...
      const cme = new ConditionMetaError(contractFunction, condition, self, args, err, util.callerStack(5))
      Object.freeze(cme)
      throw cme
    }
    if (!conditionResult) {
