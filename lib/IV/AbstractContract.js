...
/**
 * @callback condition
 * @param {...*} arg - The arguments with which the contract function was called, in order. If used as a post- or
 *                     exception condition, 2 arguments are added. The second-to-last argument is the result returned,
 *                     respectively the exception thrown, by the contract function's implementation. The last argument
 *                     is the contract function itself, for use in recursive conditions.
 * @returns {boolean}
 */
...
/**
 * Singleton array of {@link falseCondition}. Can be used the clearly signal
...
/**
 * @typedef {object} ContractKwargs
 * @property {Array<condition>} [pre=[]] preconditions
 * @property {Array<condition>} [post=[]] postconditions
 * @property {Array<condition>} [exception=mustNotHappen] exception conditions
 */
 ...
 *
 * @constructor
 * @param {ContractKwargs} kwargs - optional pre-, post-, and exception conditions for the contract
 * @param {string} [_location] - location of the contract (internal use)
 */
...
AbstractContract.prototype = {
  ...
  isImplementedBy: function (f) {
    return AbstractContract.isAGeneralContractFunction(f) && Object.getPrototypeOf(f.contract) === this
  }
}
/**
...
/**
 * Postconditions of the contract
 *
 * @name post
 * @instance
 * @type {Array<condition>}
...
/**
 * Exception conditions of the contract
 *
 * @name exception
 * @instance
 * @type {Array<condition>}
...
/**
 * Should conditions be verified when a contract function is called?
 *
 * @name verify
 * @instance
 * @type {boolean}
 * @memberof AbstractContract.prototype
 * @default true
 */
AbstractContract.prototype.verify = true
/**
 * Should post- and exception conditions be verified when a contract function is called?
 *
 * Only applies when {@link AbstractContract#verify} is `true`.
 *
 ...
 * [is also a contract function]{@link AbstractContract#isAContractFunction}.
 ...
 *
 * @returns {GeneralContractFunction} If `this` is a {@link ContractFunction}, `result` will be too.
 */
 ...
 *   </li>
 *
 * @typedef {function} GeneralContractFunction
 * @property {AbstractContract} contract
...
/**
 * Verify whether `f` is a {@link GeneralContractFunction}
 *
 * @param {*} f
 * @returns {boolean}
 */
 ...
 * </ul>
 *
 * @typedef {GeneralContractFunction} ContractFunction
 * @property {string} location
 */

/**
 * Verify whether `f` is a {@link ContractFunction}
 *
 * @param {*} f
 * @returns {boolean}
 */
 ...
 *
 * @param {function} contractFunction - the regular {@link Function} to be transformed into a contract function
 * @param {AbstractContract} contract - the contract `contractFunction` is a realisation of
 * @param {function} implFunction - the function that is used in `contractFunction`
 *                                  to realize the postconditions of <code>contract</code> under its preconditions
 * @param {string} location - the location outside this library that the resulting
 *                            [contract function]{@linkplain AbstractContract#isAContractFunction} will carry,
 *                            that says where it is defined.
 * @returns {GeneralContractFunction} Whether or not the result is a {@link ContractFunction} depends on the `location`
 *                                    passed in.
 */
...
// MUDO typedef postArgsArray - where the 2 last elements are known, and the last is a ContractFunction
 ...
 *
 * @param {Array<*>} args
 * @returns {GeneralContractFunction}
 */
