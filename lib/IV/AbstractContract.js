 ...
 */
const falseCondition = function () { return false }
...
function AbstractContract (kwargs, /* Object? */ _location) {
  ...
  assert(!_location || _location === AbstractContract.internalLocation || typeof _location === 'string', 'optional private _location is internal or a string')
  ...
  function abstract () { throw new AbstractContract.AbstractError(self, stack.raw()) }
...
AbstractContract.namePrefix = namePrefix
...
AbstractContract.bindContractFunction = function bind () {
  ...
  property.frozenDerived(
    boundImplementation,
    'name',
    () => report.conciseCondition('bound', this.implementation)
  )
...
AbstractContract.isAGeneralContractFunction = function (f) {
  ...
  console.log('typeof f.prototype', typeof f.prototype, '- f.prototype.constructor === f', f.prototype.constructor === f, '- f.prototype === f.implementation.prototype', f.prototype === f.implementation.prototype, '- f.prototype instanceof f.implementation', f.prototype instanceof f.implementation, '- Object.getPrototypeOf(f.prototype)', Object.getPrototypeOf(f.prototype), '- Object.getPrototypeOf(f.prototype) === f.implementation.prototype', Object.getPrototypeOf(f.prototype) === f.implementation.prototype, 'WHAT IS WRONG', (
  ...
  return typeof f === 'function' &&
         ...
         f.location &&
         (f === f.implementation ||
            f.name === report.conciseCondition(AbstractContract.namePrefix, f.implementation)) &&
...
AbstractContract.isAContractFunction = function (f) {
  return AbstractContract.isAGeneralContractFunction(f) && is.stackLocation(f.location)
}
...
AbstractContract.bless = function bless (contractFunction, contract, implFunction, location) {
  assert.equal(typeof contractFunction, 'function')
  ...
  assert(location === AbstractContract.internalLocation || is.stackLocation(location), 'location is internal, or a stack location')
  ...
  if (implFunction.hasOwnProperty('prototype')) {
    ...
    // assert.equals(Object.getPrototypeOf(contractFunction.prototype), implFunction.prototype)
  }
  ...
  if (contractFunction !== implFunction) {
    ...
    property.frozenDerived(
      contractFunction,
      'name',
      report.conciseCondition.bind(null, namePrefix, implFunction)
    )
  }
}
