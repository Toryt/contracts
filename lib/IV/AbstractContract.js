...
AbstractContract.isAGeneralContractFunction = function (f) {
  ...
  return typeof f === 'function' &&
         ...
         f.location &&
         (f === f.implementation ||
            f.name === report.conciseCondition(AbstractContract.displayNamePrefix, f.implementation)) &&
...
AbstractContract.bless = function bless (contractFunction, contract, implFunction, location) {
  ...
  property.setAndFreeze(contractFunction, 'contract', contract)
  ...
  if (contractFunction !== implFunction) {
    ...
    property.frozenDerived(
      contractFunction,
      'name',
      report.conciseCondition.bind(null, displayNamePrefix, implFunction)
    )
  }
}
