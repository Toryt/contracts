...
property.frozenDerived(
  ...
  function () {
    ...
    const conditionRepresentation = report.conciseConditionRepresentation('condition', this.condition)
    // noinspection JSUnresolvedVariable
...
property.setAndFreeze(
  ...
  function () {
    ...
    ${index} (${report.type(arg)}): ${report.inspect(arg)}`)
    // noinspection JSUnresolvedVariable
    return `contract:
${this.contractFunction.contract.location}
condition:
    ${report.conciseConditionRepresentation('', this.condition)}
contract function:
${this.contractFunction.location}
this (${report.type(this.self)}):
    ${report.inspect(this.self)}    
