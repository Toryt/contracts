...
function ConditionError (contractFunction, condition, self, args, rawStack) {
  assert(AbstractContract.isAGeneralContractFunction(contractFunction), 'ConditionError: first argument is a general contract function')
  assert.equal(typeof condition, 'function', 'ConditionError: condition is a function')
