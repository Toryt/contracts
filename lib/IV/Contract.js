...
function Contract (kwargs) {
  ...
  util.pre(function () { return !kwargs.pre || Array.isArray(kwargs.pre) })
  util.pre(function () { return !kwargs.post || Array.isArray(kwargs.post) })
  util.pre(function () { return !kwargs.exception || Array.isArray(kwargs.exception) })

  AbstractContract.call(this, kwargs, util.callerLocation(1))
}
...
Contract.prototype.implementation = function (implFunction) {
  util.pre(this, function () { return implFunction && typeof implFunction === 'function' })

  const contract = this
  const location = util.callerLocation(1)
