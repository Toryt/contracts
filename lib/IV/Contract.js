 ...
 *
 * When called, the returned `ContractFunction` will just execute `implFunction` if is its `contract.verify` property
 * is falsy.
 *
 ...
 *
 * If is its `contract.verifyPostconditions` property is falsy, the returned `ContractFunction` will immediately
 * return the value `implFunction` returned, or immediately throw the exception `implFunction` threw.
 *
