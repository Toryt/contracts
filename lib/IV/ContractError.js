...
function ContractError (rawStack) {
  ...
  util.setAndFreezeProperty(this, '_rawStack', rawStack)
}
...
util.setAndFreezeProperty(ContractError.prototype, '_rawStack', util.callerStack())
util.defineConfigurableDerivedProperty(
  ContractError.prototype,
  'stack',
  function () {
    // noinspection JSUnresolvedVariable
    return `${this.name}: ${this.message}${os.EOL + this._rawStack}`
  }
)
