...
PromiseContract.prototype.implementation = function (implFunction) {
  ...
  function contractFunction () {
    console.log('CALL contractFunction')
    ...
    try {
      ...
      console.log('TEST PRE contractFunction')
    ...
    if (!contractFunction.contract.verifyPostconditions) {
      console.log('CALL IMPLEMENTATION !contractFunction.contract.verifyPostconditions contractFunction')
      /* Shortcut if there is no verification.
