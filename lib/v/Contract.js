...
const ConditionError = require('../IV/ConditionError')
const AbstractContract = require('../IV/AbstractContract')
const PreconditionViolation = require('../IV/PreconditionViolation')
const PostconditionViolation = require('../IV/PostconditionViolation')
const ExceptionConditionViolation = require('../IV/ExceptionConditionViolation')
const assert = require('assert')
const PromiseContract = require('../IV/PromiseContract')
