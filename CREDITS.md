...
- **Sindre Sorhus** _sindresorhus@gmail.com_ (135 packages)
- **Jon Schlinkert** _github@sellside.com_ (68 packages)
- **James Halliday** _mail@substack.net_ (38 packages)
- **Jordan Harband** _ljharb@gmail.com_ (33 packages)
- **Titus Wormer** _tituswormer@gmail.com_ (29 packages)
- **Isaac Z. Schlueter** _isaacs@npmjs.com_ (20 packages)
- **Sebastian McKenzie** _sebmck@gmail.com_ (11 packages)
...
- **Benjamin Coe** _ben@npmjs.com_ (8 packages)
...
- **JD Ballard** _i.am.qix@gmail.com_ (7 packages)
...
- **Logan Smyth** _loganfsmyth@gmail.com_ (4 packages)
...
- **Mathias Buus** _mathiasbuus@gmail.com_ (3 packages)
...
- **Justin Ridgewell** _justin@ridgewell.name_ (1 package)
...
- **Ilya Radchenko** _knownasilya@gmail.com_ (1 package)
...
- **Matthew Davidson** _matthew.davidson@skyscanner.net_ (1 package)
...
- **Denis Pushkarev** _zloirock@zloirock.ru_ (1 package)
...
- **Steven Levithan** _steves_list@hotmail.com_ (1 package)
...
- **Eric Ferraiuolo** _edf@ericf.me_ (1 package)
...
- **Jos de Jong** _wjosdejong@gmail.com_ (1 package)
